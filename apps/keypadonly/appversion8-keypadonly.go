...
func App8() *fyne.Container {
	...
	entry := NewEntryField(entryString)
...
func NewEntryField(entryString utils.BS) fyne.CanvasObject {
	l := widget.NewLabelWithData(entryString)
	o := canvas.NewRectangle(color.Transparent)
	o.StrokeWidth = 1
	o.StrokeColor = color.RGBA{0, 0, 255, 255}
	return container.NewStack(o, l)
}
